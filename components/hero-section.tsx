      ...
      <div className="max-w-[1280px] mx-auto px-4 md:px-8 lg:px-12">
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-16">
          ...
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left">
            ...
            <p
              className={cn(
                "text-lg text-neutral-700 leading-relaxed max-w-[600px] mb-6 transition-all duration-700",
                isInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
              )}
            ...
            <div
              className={cn(
                "flex flex-col sm:flex-row items-center lg:items-start gap-4 sm:gap-6 mb-8 transition-all duration-700",
                isInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
              )}
            ...
            >
              <Link
                ...
                className="inline-flex items-center gap-2 text-neutral-700 hover:text-primary-700 transition-colors duration-300"
              >
